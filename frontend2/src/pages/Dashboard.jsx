  ...
  return (
    <div
      onClick={() => {
        ...
        else if (title === "Try Career Assessment") navigate("/career-assessment");
    ...
    <div className="min-h-screen bg-[#0f0f1a] text-white font-inter p-6 relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <header className="flex justify-between items-center mb-8">
          <h1 style={{ WebkitTextStroke: "1px white" }} className="text-2xl font-extrabold tracking-tight">
          ...
          {navItems.map((item) => (
            <button
              ...
              onClick={() => {
                ...
                if (item.id === "guide") navigate("/career-guide");
                if (item.id === "sim") navigate("/career-assessment");
                if (item.id === "graph") navigate("/roadmap"); // 👈 added roadmap route
              }}
