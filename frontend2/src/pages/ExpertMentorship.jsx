...
const experts = [
    ...
    },
    {
        ...
        description: "Award-winning designer with experience at top tech companies. Passionate about mentoring.",
        available: true,
    },
    {
        emoji: "👩‍💻",
        ...
        description: "Built marketing teams from scratch. Expert in digital marketing and brand building.",
        available: false,
    },
    {
        emoji: "👨‍💻",
        ...
        description: "Senior doctor with 15+ years experience. Guides students through medical career paths.",
        available: true,
    },
];
                    ...
                    >
                        ...
                        <div className="flex justify-center gap-2 flex-wrap mb-3">
                            {expert.tags.map((tag, i) => (
                                <span key={i} className="bg-purple-900/40 text-purple-300 text-xs px-3 py-1 rounded-full font-semibold">
                                    {tag}
                                </span>
                            ))}
                        </div>
                        ...
                        <button
                            ...
                            className={`w-full py-2 rounded-lg font-medium cursor-pointer ${expert.available
                                    ? "bg-purple-600 hover:bg-purple-700"
                                    : "bg-gray-600 cursor-not-allowed"
                                }`}
                        >
                            {expert.available ? "Book Session" : "Currently Unavailable"}
                        </button>
                    </div>
                ))}
            </div>
