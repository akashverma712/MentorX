...
import ExpertMentorship from './ExpertMentorship'
      ...
      <div className="w-full max-w-7xl flex flex-col md:flex-row items-center justify-between gap-10">
        ...
        >
          ...
          <div className="flex flex-wrap gap-4">
           <button className="cursor-pointer bg-linear-to-r from-indigo-500 via-purple-500 to-pink-500 text-white font-semibold px-6 py-3 rounded-full shadow-lg hover:scale-105 transition-transform"> <a href="/dashboard">
              {t("hero.button")}
            </a></button>
